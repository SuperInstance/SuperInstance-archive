...
class ConversationEngine:
    ...
    def __init__(self, character_manager: CharacterManager,
        ...
        self.models = {
            ...
            "claude-sonnet": ChatAnthropic(model="claude-sonnet-4-20250514", temperature=0.7),
        }
    ...
    async def start_room_conversation(self, room_id: str, 
        ...
        # Get characters
        characters = [
            self.character_manager.get_character(char_id)
...
"""
    ...
    def _select_model_for_room(self, room: Room) -> str:
        """Select appropriate model based on room type"""
        
        # Use more powerful models for creative/complex rooms
        if room.room_type in [RoomType.JAZZ_CLUB, RoomType.DEBATE_HALL, 
                               RoomType.MEDITATION_GARDEN]:
            return "claude-sonnet"
        
        # Use cheaper model for casual conversation
        elif room.room_type in [RoomType.COFFEE_HOUSE, RoomType.STUDY_HALL]:
            return "gpt-4o-mini"
