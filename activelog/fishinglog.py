...
class FishingLogHandler(BaseHTTPRequestHandler):
    entries = []
...
print(f"Starting FishingLog API on port {port}...")
FishingLogHandler.load_entries()
print(f"Loaded {len(FishingLogHandler.entries)} existing entries")
HTTPServer(('0.0.0.0', port), FishingLogHandler).serve_forever()
